  ...
  return (
    <TermsContainer>
      <Wrapper>
        ...
        <p>These terms and conditions outline the rules and regulations for the use of CSS Convertor's Website, located
          at https://www.cssconvertor.com/.</p>
        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use CSS
          Convertor if you do not agree to take all of the terms and conditions stated on this page.</p>
        <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
          ...
          Company's stated services, in accordance with and subject to, prevailing law of br. Any use of the above
        ...
        <p>We employ the use of cookies. By accessing CSS Convertor, you agreed to use cookies in agreement with the CSS
          Convertor's Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, CSS Convertor and/or its licensors own the intellectual property rights for all
          material on CSS Convertor. All intellectual property rights are reserved. You may access this from CSS
          Convertor for your own personal use subjected to restrictions set in these terms and conditions.</p>
        <p>You must not:</p>
        <ul>
        ...
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
          areas of the website. CSS Convertor does not filter, edit, publish or review Comments prior to their presence
          on the website. Comments do not reflect the views and opinions of CSS Convertor,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their views and opinions. To the extent
          permitted by applicable laws, CSS Convertor shall not be liable for the Comments or for any liability, damages
        ...
        <p>CSS Convertor reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant CSS Convertor a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
          ...
          records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of CSS
          Convertor; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
          you must inform us by sending an e-mail to CSS Convertor. Please include your name, your organization name,
        ...
        <p>No use of CSS Convertor's logo or other artwork will be allowed for linking absent a trademark license
          agreement.</p>
